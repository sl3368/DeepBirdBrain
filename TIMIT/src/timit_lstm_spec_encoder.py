...
from load_timit import get_timit_specs
...
savefilename = '/vega/stats/users/sl3368/TIMIT/saves/params/timit_lstm_spec_5.save'
results_filename='/vega/stats/users/sl3368/TIMIT/results/timit_lstm_spec_5.out'
...
#
# Load the dataset
#train_x, train_y, test_x, test_y = get_timit_specs()
