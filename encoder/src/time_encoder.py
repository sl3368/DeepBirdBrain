...
savefilename = '/vega/stats/users/sl3368/encoder/saves/params/convae_time_nopad_10_1st.save'
results_filename='/vega/stats/users/sl3368/encoder/results/convae_time_nopad_10_1st.out'
datapathpre = '/vega/stats/users/sl3368/Data_LC/NopadNormData/'

load_params = False
load_params_filename = ''
...
layer0 = LeNetConvPoolLayer(
    ...
    filter_shape=( layer0_filters, 1, 20, 5),
    poolsize=(5, 1),
    dim2 = 1
)
...
layer1 = LeNetConvPoolLayer(
    ...
    filter_shape=( layer1_filters, layer0_filters, 10, 5),
    poolsize=(2, 1),
    dim2 = 1
)
...
layer2 = LeNetConvPoolLayer(
    ...
    filter_shape=( layer2_filters, layer1_filters, 5, 2),
    poolsize=(2, 1),
    dim2 = 1
)
...
layer2.reverseConv(layer3.reverseOutput,(minibatch_size,layer2_filters,100,60),(layer1_filters,layer2_filters,5,2))

layer1.reverseConv(layer2.reverseOutput,(minibatch_size,layer1_filters,200,60),(layer0_filters,layer1_filters,10,5))

layer0.reverseConv(layer1.reverseOutput,(minibatch_size,layer0_filters,1000,60),(1,layer0_filters,20,5)) #filter flipped on first two axes
