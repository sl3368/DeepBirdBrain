...
savefilename = '/vega/stats/users/sl3368/encoder/results/textures/temporal/final_gram_imgs_'
results_filename='/vega/stats/users/sl3368/encoder/results/textures/temporal/texture_gen_convae_5layer_10_'
datapathpre = '/vega/stats/users/sl3368/Data_LC/NopadNormData/'
originalfn = '/vega/stats/users/sl3368/encoder/results/textures/temporal/original_gram_imgs_'
initfn = '/vega/stats/users/sl3368/encoder/results/textures/temporal/init_gram_imgs_'
...
init = rand(1,1,1000,60).astype('f')
...
layer0.calcGramMatrix(False,layer0_filters, 1000 * 60)
layer1.calcGramMatrix(False,layer1_filters, 200 * 60)
layer2.calcGramMatrix(False,layer2_filters, 100 * 60)
layer3.calcGramMatrix(False,layer3_filters, 50 * 60)
layer4.calcGramMatrix(False,layer4_filters, 25 * 60)
...
cost0 = T.sum( (T_mat0-g0_matrix) **2 )/ (layer0_filters*layer0_filters*1000*1000*60*60*4)
cost1 = T.sum( (T_mat1-g1_matrix) **2 )/ (layer1_filters*layer1_filters*200*200*60*60*4)
cost2 = T.sum( (T_mat2-g2_matrix) **2 )/ (layer2_filters*layer2_filters*100*100*60*60*4)
cost3 = T.sum( (T_mat3-g3_matrix) **2 )/ (layer3_filters*layer3_filters*50*50*60*60*4)
cost4 = T.sum( (T_mat4-g4_matrix) **2 )/ (layer4_filters*layer4_filters*25*25*60*60*4)
...
# Reshape matrix of rasterized images of shape (batch_size, 2000 * 60)
# to a 4D tensor, compatible with our LeNetConvPoolLayer
r_layer0_input = r_x.reshape((minibatch_size, 1, 1000, 60))
...
r_layer0.calcGramMatrix(False,layer0_filters, 1000 * 60)
r_layer1.calcGramMatrix(False,layer1_filters, 200 * 60)
r_layer2.calcGramMatrix(False,layer2_filters, 100 * 60)
r_layer3.calcGramMatrix(False,layer3_filters, 50 * 60)
r_layer4.calcGramMatrix(False,layer4_filters, 25 * 60)
