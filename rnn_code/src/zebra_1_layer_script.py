...
results_filename='/vega/stats/users/sl3368/rnn_code/results/lstm/1_layer/1000/zebra_1st_4_3000.out'
...
savefilename = '/vega/stats/users/sl3368/rnn_code/saves/params/lstm/1_layer/1000/zebra_1st_4_3000.save'
...
while (epoch < n_epochs):
    ...
    for minibatch_index in xrange(4,5):
