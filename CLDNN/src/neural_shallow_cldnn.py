...
results_filename='/vega/stats/users/sl3368/CLDNN/results/neural/shallow/'+brain_region+'_'+str(held_out_song)+'.out'

#check if exists already, then load or not load 
load_params_pr_filename = '/vega/stats/users/sl3368/CLDNN/saves/neural/shallow/'+brain_region+'_'+str(held_out_song)+'.save'
...
savefilename = '/vega/stats/users/sl3368/CLDNN/saves/neural/shallow/'+brain_region+'_'+str(held_out_song)+'.save'

neurons_savefilename ='/vega/stats/users/sl3368/CLDNN/saves/neural/shallow/'+brain_region+'_'+str(held_out_song)+'.save_neurons'

psth_savefilename ='/vega/stats/users/sl3368/CLDNN/saves/psth/shallow/'+brain_region+'_'+str(held_out_song)+'.psth'
