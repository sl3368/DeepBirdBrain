...
results_filename='/vega/stats/users/sl3368/CLDNN/results/deep_linreg.out'

#Directive and path for loading previous parameters
load_params = False
load_params_filename = '/vega/stats/users/sl3368/CLDNN/saves/deep_one_ahead_1st.save'

song_size = 2459

#filepath for saving parameters
savefilename = '/vega/stats/users/sl3368/CLDNN/saves/deep_linreg.save'
